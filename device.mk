...
# Device path
DEVICE_PATH := device/sony/akatsuki/rootdir
...
PRODUCT_AARDVARK_CONFIG := normal
PRODUCT_AARDVARK_PREBUILT_DPI := xxhdpi xhdpi hdpi
PRODUCT_AARDVARK_PREF_CONFIG := xxhdpi
